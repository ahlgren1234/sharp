    ...
    <div class="container">
        <div class="col-md-12">
            <div class="showcase-content">
                <h1><?php echo get_theme_mod( 'showcase_heading', 'Sharp Theme' ); ?></h1>
                <p class="lead"><?php echo get_theme_mod( 'showcase_text', 'The Stylish WordPress Theme' ); ?></p>
        ...
        <div class="container">
            <div class="row">
                <div class="<?php echo $left_class; ?>">
                    <hr class="section-heading-spaces">
